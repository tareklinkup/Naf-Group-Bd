...
<ul class="nav nav-list">
    ...
    <li class="">
        <a href="<?php echo base_url(); ?>returnIemi">
            <i class="menu-icon fa fa-usd"></i>
            <span class="menu-text"> IMEI sale Return </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>

    <?php if (array_search("iemiHistory", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>iemiHistory">
            <i class="menu-icon fa fa-usd"></i>
            <span class="menu-text"> IEMI Serial History </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>
...
<ul class="nav nav-list">
    ...
    <li class="">
        <a href="<?php echo base_url(); ?>purchaseReturnsImei">
            ...
            <span class="menu-text"> IMEI Purchase Return </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>
...
<ul class="nav nav-list">
    ...
    <?php if (array_search("dailyattendence", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>dailyattendence">
            <i class="menu-icon fa fa-money"></i>
            <span class="menu-text"> Daily Attendence </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>

    <?php if (array_search("pending_attendence", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>pending_attendence">
            <i class="menu-icon fa fa-money"></i>
            <span class="menu-text"> Pending Attendence </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>

    <?php if (array_search("attendence_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>attendence_record">
            <i class="menu-icon fa fa-money"></i>
            <span class="menu-text"> Attendence Record </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>
    ...
    <?php if (array_search("leave_entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>leave_entry">
            <i class="menu-icon fa fa-money"></i>
            <span class="menu-text"> Leave Entry </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>
    ...
    <?php if (array_search("leave_entry_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>leave_entry_report">
            <i class="menu-icon fa fa-list-ol"></i>
            <span class="menu-text"> Leave Entry Report </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>
